...
async function main() {
    ...
    //   const JFKToken = await hre.ethers.getContractFactory("JFKToken");
    //   const tokenContract = await JFKToken.deploy();
    //   const SmartFunding = await hre.ethers.getContractFactory("SmartFunding");
    //   const smartFunding = await SmartFunding.deploy(tokenContract);
